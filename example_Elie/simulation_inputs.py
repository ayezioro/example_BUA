...
alternative_value_replacement_frequencies = [i*5 for i in range(1,6)]

bipv_scenarios_param_dict = {
    "alternative_"+str(value) : baseline_scenario for value in alternative_value_replacement_frequencies

}

for value in alternative_value_replacement_frequencies:
    bipv_scenarios_param_dict["alternative_"+str(value)]["replacement frequency"] = value
